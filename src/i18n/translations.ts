...
const ca = {
  ...
  formLoanName: 'Nom del préstec',
  formLoanNamePlaceholder: 'p.ex. PRÉSTEC PERSONAL',
  formLender: 'Prestador (qui presta)',
  formLenderPlaceholder: 'Nom del prestador',
  formBorrower: 'Prestatari (qui rep)',
  formBorrowerPlaceholder: 'Nom del prestatari',
  formAmount: 'Import prestat',
  formCurrency: 'Moneda',
  formStartDate: 'Data d\'inici',
  formStatus: 'Estat',
  formNotes: 'Notes (opcional)',
  formNotesPlaceholder: 'Detalls addicionals…',
  formDate: 'Data',
  formTime: 'Hora',
  formPaymentMethod: 'Mètode de pagament',
  formSender: 'Ordenant / Emissor',
  formSenderPlaceholder: 'Nom de qui fa el pagament',
  formConcept: 'Concepte',
  formConceptPlaceholder: 'Concepte del moviment',
  formBank: 'Banc',
  formBankPlaceholder: 'Nom del banc',
  formIban: 'IBAN (parcial)',
  formIbanPlaceholder: 'ES12 **** **** 4567',
  formOpCode: 'Codi operació',
  formOpCodePlaceholder: 'OP-XXXX',
  formRef: 'Referència',
  formRefPlaceholder: 'REF-XXXX',
  formNotesPayment: 'Notes (opcional)',
  formNotesPaymentPlaceholder: 'Notes addicionals…',
  chartsAmountLabel: 'Import',
  chartsTargetLabel: 'Objectiu',
  chartsMonthLabel: 'Total mes',
  chartsTotalLabel: 'Total',
  newPayDeleteImage: 'Eliminar imatge',
  reviewAcceptSave: 'Acceptar i guardar',
  loansStart: 'Inici',
  loansMovement: 'moviment',
  loansMovements: 'moviments',
  dashReturn: 'Tornar als préstecs',
  cloudCancel: 'Cancel·lar',
  cloudSave: 'Guardar',
  cloudSyncErrorsTitle: 'Errors de sincronització',
  cloudConfigDropbox: 'Configurar Dropbox',
  cloudConfigOnedrive: 'Configurar OneDrive',
  modalClose: 'Tancar',
  loadingLoans: 'Carregant préstecs…',
  loadingLoan: 'Carregant préstec…',
  loadingDashboard: 'Carregant dashboard…',
  loadingHistory: 'Carregant historial…',
  loadingDetail: 'Carregant detall…',
  loadingCharts: 'Carregant gràfics…',
  loadingCloud: 'Carregant configuració…',
  comingSoon: 'Properament',
  detailRef: 'Referència',
  attempt: 'Intent',
  cloudSettings: 'Configuració del núvol',
  configureGoogleDrive: 'Configura Google Drive',
  connect: 'Connectar',
  connected: 'Connectat',
  disconnected: 'Desconnectat',
  googleClientIdHint: 'El trobaràs a Google Cloud Console → Credencials',
  googleClientIdNeeded: 'Per connectar necessites un Client ID.',
  howItWorks: 'Com funciona',
  retry: 'Reintentar',
  syncStatus: 'Estat de sincronització',
  viewErrors: 'Veure errors',
